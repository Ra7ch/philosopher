...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/03/04 13:54:00 by raitmous          #+#    #+#             */
/*   Updated: 2023/03/05 18:26:41 by raitmous         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	print_error(int i, int arg)
{
	...
	if (i == 2)
	{
		if (arg == 1)
		{
			...
			printf("Number of philosophers can't be negative or null.\n");
		}
		else if (arg == 5)
		{
			printf("Unvalid Number: ");
			printf("Eating count can't be negative or null.\n");
		}
		else
		{
			printf("Unvalid Number: ");
			printf("Time can't be negative or null.\n");
		}
	}
}
